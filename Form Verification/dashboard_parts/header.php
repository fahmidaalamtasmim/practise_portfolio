...
$select_msg = "SELECT * FROM messages WHERE status=0";
$select_msg_res = mysqli_query($db_connection, $select_msg);
//$after_assoc_msg = mysqli_fetch_assoc($select_msg_res);


$count = "SELECT COUNT(*) as total FROM messages WHERE status=0";
$count_res = mysqli_query($db_connection, $count);
$after_assoc_count = mysqli_fetch_assoc($count_res);
...
<head>
	...
	<link rel="stylesheet" href="/web dev 2205/Form Verification/dashboard_asset/vendor/chartist/css/chartist.min.css">
	<link href="/web dev 2205/Form Verification/dashboard_asset/vendor/bootstrap-select/dist/css/bootstrap-select.min.css" rel="stylesheet">
	<link href="/web dev 2205/Form Verification/dashboard_asset/vendor/owl-carousel/owl.carousel.css" rel="stylesheet">
        ...
        ***********************************-->
		<div class="nav-header">
			<a href="index.html" class="brand-logo">
				<img class="logo-abbr" src="/web dev 2205/Form Verification/dashboard_asset/images/logo.png" alt="">
				<img class="logo-compact" src="/web dev 2205/Form Verification/dashboard_asset/images/logo-text.png" alt="">
				<img class="brand-title" src="/web dev 2205/Form Verification/dashboard_asset/images/logo-text.png" alt="">
			</a>
					...
					<div class="tab-pane fade active show" id="chat" role="tabpanel">
								...
								<ul class="contacts">
									...
									<li class="active dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="/web dev 2205/Form Verification/dashboard_asset/images/avatar/1.jpg" class="rounded-circle user_img" alt="" />
									...
									<li class="dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="/web dev 2205/Form Verification/dashboard_asset/images/avatar/2.jpg" class="rounded-circle user_img" alt="" />
									...
									<li class="dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="/web dev 2205/Form Verification/dashboard_asset/images/avatar/3.jpg" class="rounded-circle user_img" alt="" />
												<span class="online_icon"></span>
											</div>
											<div class="user_info">
									...
									<li class="dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="/web dev 2205/Form Verification/dashboard_asset/images/avatar/4.jpg" class="rounded-circle user_img" alt="" />
												<span class="online_icon offline"></span>
											</div>
											<div class="user_info">
									...
									<li class="dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="/web dev 2205/Form Verification/dashboard_asset/images/avatar/5.jpg" class="rounded-circle user_img" alt="" />
												<span class="online_icon offline"></span>
											</div>
											<div class="user_info">
						...
						<div class="card chat dz-chat-history-box d-none">
							...
							<div class="card-body msg_card_body dz-scroll" id="DZ_W_Contacts_Body3">
								...
								<div class="d-flex justify-content-start mb-4">
									<div class="img_cont_msg">
										<img src="/web dev 2205/Form Verification/dashboard_asset/images/avatar/1.jpg" class="rounded-circle user_img_msg" alt="" />
									</div>
									<div class="msg_cotainer">
								...
								<div class="d-flex justify-content-end mb-4">
									...
									<div class="img_cont_msg">
										<img src="/web dev 2205/Form Verification/dashboard_asset/images/avatar/2.jpg" class="rounded-circle user_img_msg" alt="" />
									</div>
								</div>
								<div class="d-flex justify-content-start mb-4">
									<div class="img_cont_msg">
								...
								<div class="d-flex justify-content-end mb-4">
									...
									<div class="img_cont_msg">
										<img src="/web dev 2205/Form Verification/dashboard_assetimages/avatar/2.jpg" class="rounded-circle user_img_msg" alt="" />
									</div>
								</div>
								<div class="d-flex justify-content-start mb-4">
									<div class="img_cont_msg">
										<img src="/web dev 2205/Form Verification/dashboard_assetimages/avatar/1.jpg" class="rounded-circle user_img_msg" alt="" />
									</div>
									<div class="msg_cotainer">
										I am looking for your next templates
										<span class="msg_time">9:07 AM, Today</span>
						...
						<ul class="navbar-nav header-right">
							...
							<li class="nav-item dropdown notification_dropdown">
								<a class="nav-link  ai-icon" href="javascript:void(0)" role="button" data-toggle="dropdown">
									...
									<div class="pulse-css">
										<span><?= $after_assoc_count['total'] ?></span>
									</div>
								</a>
								<div class="dropdown-menu rounded dropdown-menu-right">
									<div id="DZ_W_Notification1" class="widget-media dz-scroll p-3 height380">
										<ul class="timeline">
											...
											foreach ($select_msg_res as $msg) { ?>

												<li>
													<a href="message_view.php?id=<?= $msg['id'] ?>">

														<div class="timeline-panel">
															<div class="media mr-2">
																<img alt="image" width="50" src="/web dev 2205/Form Verification/dashboard_asset/images/avatar/1.jpg">
															</div>
															<div class="media-body">
																<h6 class="mb-1"><?= $msg['name'] ?></h6>
																<!-- <small class="d-block">< ?=date($msg['date'])?></small> -->
																<small class="d-block"><?= $msg['date'] ?></small>
															</div>
														</div>
							...
							<li class="nav-item dropdown header-profile">
								<a class="nav-link" href="javascript:void(0)" role="button" data-toggle="dropdown">
									...
									<?php if ($after_assoc['photo'] == null) { ?>
										<img src="/web dev 2205/Form Verification/dashboard_asset/images/profile/17.jpg" width="20" alt="" />

									<?php } else { ?>
										<img width="20" src="/web dev 2205/Form Verification/uploads/pics/<?= $after_assoc['photo'] ?>" alt="">
									<?php } ?>
								...
								<div class="dropdown-menu dropdown-menu-right">
									...
									<a href="/web dev 2205/Form Verification/logout.php" class="dropdown-item ai-icon">
		...
		<div class="deznav">
			<div class="deznav-scroll">
				<ul class="metismenu" id="menu">
					<li><a class="has-arrow ai-icon" href="/web dev 2205/Form Verification/dashboard.php" aria-expanded="false">
							<i class="flaticon-381-networking"></i>
							<span class="nav-text">Dashboard</span>
						</a>

					</li>
					<li><a class="has-arrow ai-icon" href="/web dev 2205/Form Verification/user/users.php" aria-expanded="false">
					...
					<!-- dublicate logo starts -->

					<li><a class="has-arrow ai-icon" href="/web dev 2205/Form Verification/logo/add_logo.php" aria-expanded="false">
							<i class="flaticon-381-television"></i>
					...
					<!-- banner starts  -->
					<li><a class="has-arrow ai-icon" href="/web dev 2205/Form Verification/banner/edit_banner.php" aria-expanded="false">
							<i class="flaticon-381-television"></i>
					...
					<!-- banner ends -->
					<!-- social starts -->
					<li><a class="has-arrow ai-icon" href="/web dev 2205/Form Verification/social/social.php" aria-expanded="false">
							<i class="flaticon-381-television"></i>
					...
					<!-- social ends -->
					<!-- skills -->
					<li><a class="has-arrow ai-icon" href="/web dev 2205/Form Verification/skill/skill.php" aria-expanded="false">
							<i class="flaticon-381-television"></i>
					...
					<!-- <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
						...
						<ul aria-expanded="false">
							<li><a href="/web dev 2205/Form Verification/services/services.php">Add new services</a></li>
						</ul>
					</li> -->
					<li><a class="has-arrow ai-icon" href="/web dev 2205/Form Verification/services/services.php" aria-expanded="false">
							<i class="flaticon-381-television"></i>
							<span class="nav-text">Services</span>
						</a>
					</li>
					...
					<!-- <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
						...
						<ul aria-expanded="false">
							<li><a href="/web dev 2205/Form Verification/works/works.php">Add new Works</a></li>
						</ul>
					</li> -->
					<li><a class="has-arrow ai-icon" href="/web dev 2205/Form Verification/works/works.php" aria-expanded="false">
							<i class="flaticon-381-television"></i>
							<span class="nav-text">Works</span>
						</a>
					</li>
					...
					<!-- <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
						...
						<ul aria-expanded="false">
							<li><a href="/web dev 2205/Form Verification/message/message_show.php">See messages</a></li>
						</ul>
					</li> -->
					<li><a class="has-arrow ai-icon" href="/web dev 2205/Form Verification/message/message_show.php" aria-expanded="false">
							<i class="flaticon-381-television"></i>
							<span class="nav-text">Messages</span>
						</a>
					</li>
					...
					<!-- message ends -->
					<!-- menu starts -->
					<li><a class="has-arrow ai-icon" href="/web dev 2205/Form Verification/menu/menu.php" aria-expanded="false">
							<i class="flaticon-381-television"></i>
					...
					<!-- menu ends  -->
					<!-- count starts  -->
					<li><a class="has-arrow ai-icon" href="/web dev 2205/Form Verification/count/count.php" aria-expanded="false">
							<i class="flaticon-381-television"></i>
					...
					<!-- count ends  -->
					<!-- testimonial -->
					<li><a class="has-arrow ai-icon" href="/web dev 2205/Form Verification/testimonial/testimonial_form.php" aria-expanded="false">
							<i class="flaticon-381-television"></i>
					...
					<!-- testimonial -->
					<!-- brand -->
					<li><a class="has-arrow ai-icon" href="/web dev 2205/Form Verification/brand_logo/brand.php" aria-expanded="false">
							<i class="flaticon-381-television"></i>
					...
					<!-- brand -->
					<!-- contact -->
					<li><a class="has-arrow ai-icon" href="/web dev 2205/Form Verification/contact/contact_form.php" aria-expanded="false">
							<i class="flaticon-381-television"></i>
