...
$id = $_GET['id'];
/////
$select4= "SELECT * FROM works WHERE id=$id";
$select_res4 = mysqli_query($db_connection, $select4);
$after_assoc = mysqli_fetch_assoc($select_res4);
                        ...
                        <div class="col-xl-9 col-lg-10">
                            <div class="single-blog-list">
                                <div class="blog-list-thumb mb-35">
                                    <img src="uploads/work/featured_image/<?=$after_assoc['featured_image']?>" alt="img">
                                </div>
                                    ...
                                    <div class="blog-list-meta">
                                        <ul>
                                            ...
                                            <li class="blog-post-share">
                                                ...
                                                <a href="https://twitter.com/share?url=portfolio-single.php?id=<?=$id?>"><i class="fab fa-twitter"></i></a>
                                        ...
                                        <li>
                                            ...
                                            <?php if($after_assoc_user['photo']==null){?>
                                                <img src="img/blog/post_avatar_img.png" alt="img">
                                                  <?php }else{ ?>
                                                    <img width="100" height="100" src="uploads/pics/<?=$after_assoc_user['photo']?>" alt="img">
                                                    <?php } ?>
                                            </div>
